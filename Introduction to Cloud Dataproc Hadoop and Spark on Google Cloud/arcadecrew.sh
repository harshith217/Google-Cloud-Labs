...
echo -e "\e[1;34mStarting cluster creation...\e[0m"
while true; do
    ...
    if [[ $? -eq 0 ]]; then
        echo -e "\e[1;32mCluster creation successful!\e[0m"
        break
    else
        echo -e "\e[1;31mCluster creation failed. Retrying in 10 seconds...\e[0m"
        sleep 10
    fi
done

# Wait until cluster is in a RUNNING state
