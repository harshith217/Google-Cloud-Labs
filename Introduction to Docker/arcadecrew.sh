...
echo "${CYAN_TEXT}${BOLD_TEXT}│ Please replace '$REGION' (e.g., us-central1)  │${RESET_FORMAT}"
read -p "${BLUE_TEXT}${BOLD_TEXT}│ Enter your desired region:                     │${RESET_FORMAT}" REGION
echo "${YELLOW_TEXT}${BOLD_TEXT}└────────────────────────────────────────────────┘${RESET_FORMAT}"
...
read -p "${BLUE_TEXT}${BOLD_TEXT}│ Enter GCP project ID:                           │${RESET_FORMAT}" DEVSHELL_PROJECT_ID
echo "${YELLOW_TEXT}${BOLD_TEXT}└────────────────────────────────────────────────┘${RESET_FORMAT}"
