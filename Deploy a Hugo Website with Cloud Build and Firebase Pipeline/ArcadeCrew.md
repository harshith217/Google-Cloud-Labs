...
[![Lab Link](https://img.shields.io/badge/Open_Lab-Cloud_Skills_Boost-4285F4?style=for-the-badge&logo=google&logoColor=white)](https://www.cloudskillsboost.google/focuses/14353?parent=catalog)
...
```
export ZONE=$(gcloud compute instances list hugo-dev-vm --format 'csv[no-heading](zone)')
gcloud compute ssh hugo-dev-vm --project=$DEVSHELL_PROJECT_ID --zone=$ZONE --quiet
```
