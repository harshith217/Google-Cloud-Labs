...
echo -n -e "${YELLOW_TEXT}${BOLD_TEXT}Enter the DATASET value:${RESET_FORMAT} "
read DATASET
export DATASET
echo
echo -n -e "${YELLOW_TEXT}${BOLD_TEXT}Enter the BUCKET value:${RESET_FORMAT} "
read BUCKET
export BUCKET
echo
echo -n -e "${YELLOW_TEXT}${BOLD_TEXT}Enter the TABLE value:${RESET_FORMAT} "
read TABLE
export TABLE
echo
...
echo "${GREEN}${BOLD}Creating an API key with display name 'arcadecrew'...${RESET}"
