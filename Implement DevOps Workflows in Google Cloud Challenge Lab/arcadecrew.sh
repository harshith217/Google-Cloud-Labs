...
echo "${WHITE_TEXT}${BOLD_TEXT}Waiting for repository setup to complete...${RESET_FORMAT}"
for i in {20..1}; do
  echo -ne "\r${YELLOW_TEXT}${BOLD_TEXT}⏳ $i seconds remaining...${RESET_FORMAT}"
  sleep 1
done
...
echo "${WHITE_TEXT}${BOLD_TEXT}Waiting for development deployment to complete...${RESET_FORMAT}"
for i in {120..1}; do
  echo -ne "\r${YELLOW_TEXT}${BOLD_TEXT}⏳ $i seconds remaining...${RESET_FORMAT}"
  sleep 1
done
...
echo "${WHITE_TEXT}${BOLD_TEXT}Waiting for production deployment to complete...${RESET_FORMAT}"
for i in {80..1}; do
  echo -ne "\r${YELLOW_TEXT}${BOLD_TEXT}⏳ $i seconds remaining...${RESET_FORMAT}"
  sleep 1
done
...
echo "${WHITE_TEXT}${BOLD_TEXT}Waiting for development v2.0 deployment to complete...${RESET_FORMAT}"
for i in {120..1}; do
  echo -ne "\r${YELLOW_TEXT}${BOLD_TEXT}⏳ $i seconds remaining...${RESET_FORMAT}"
  sleep 1
done
...
echo "${WHITE_TEXT}${BOLD_TEXT}Waiting for production v2.0 deployment to complete...${RESET_FORMAT}"
for i in {70..1}; do
  echo -ne "\r${YELLOW_TEXT}${BOLD_TEXT}⏳ $i seconds remaining...${RESET_FORMAT}"
  sleep 1
done
