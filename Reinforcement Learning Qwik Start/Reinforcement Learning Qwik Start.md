...
```bash
curl -LO raw.githubusercontent.com/ArcadeCrew/Google-Cloud-Labs/refs/heads/main/Reinforcement%20Learning%20Qwik%20Start/arcadecrew.sh
...
### 📂 **Open User-managed Notebooks**  
Click [here](https://console.cloud.google.com/vertex-ai/workbench/user-managed?) to access User-managed Notebooks.
