...
echo
echo "${BLUE_TEXT}${BOLD_TEXT}Creating a new VM instance named 'speaking-with-a-webpage'...${RESET_FORMAT}"
echo "${YELLOW_TEXT}${BOLD_TEXT}This may take a few moments. Please wait.${RESET_FORMAT}"
